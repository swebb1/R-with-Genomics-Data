---
title: "Plotting sequencing data around genomic annotations"
...
# 7. Plot profiles across regions of interest

A common task in sequencing analysis is to plot profiles of particular signals across regions of interest. For instance ChIP-seq reads across the TSS of genes. You've probably guessed by now but there are many different ways to do this in R! Here we introduce *seqplots* which is one of the more intuitive packages. 
...
##Next we have a list of tracks. This is the data we intend to plot. We can supply the file path of bigWig files directly:
##H3K4me3 ChIP-seq read profiles
H3K4me3.chip<-"/homes/swebb/data/Shaun/training/ROI_workshop/data/H3K4me3.bw"
##H3K27me3 ChIP-seq read profiles
H3K27me3.chip<-"/homes/swebb/data/Shaun/training/ROI_workshop/data/H3K27me3.bw"
